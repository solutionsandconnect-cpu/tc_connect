...
class _AccueilWidgetState extends State<AccueilWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      Function() _navigate = () {};
      if (loggedIn) {
        _model.comptageNotifNonLues = await queryNotificationsRecordCount(
        ...
        if (_model.comptageNotifNonLues! > 0) {
          await showDialog(
            context: context,
                                    ...
                                    Expanded(
                                      child: AuthUserStreamWidget(
                                        builder: (context) => Text(
                                          'Bienvenue ${valueOrDefault(currentUserDocument?.prenom, '')}',
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            FFAppState().PageActuelle =
                                                'Planning';
                                            FFAppState().update(() {});

                                            context.pushNamed(
                                                PlanningWidget.routeName);
                                          },
                                          child: Container(
                                            decoration: BoxDecoration(
                                              color:
