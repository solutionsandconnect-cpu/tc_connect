...
abstract class FlutterFlowTheme {
  ...
  late Color accentRed;
  late Color etatBon;
  late Color etatMoy;
  late Color etatPasBon;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF737374);
  ...
  late Color accentRed = const Color(0x4DA1020C);
  late Color etatBon = const Color(0xFF39D278);
  late Color etatMoy = const Color(0xFFEEAD60);
  late Color etatPasBon = const Color(0xFFEE6060);
}
