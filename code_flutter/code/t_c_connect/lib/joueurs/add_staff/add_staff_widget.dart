...
class AddStaffWidget extends StatefulWidget {
  const AddStaffWidget({
    super.key,
    this.parametreAddStaffEquipe,
    this.parametreAddStaffUser,
  });

  final TeamRecord? parametreAddStaffEquipe;
  final UsersRecord? parametreAddStaffUser;
...
class _AddStaffWidgetState extends State<AddStaffWidget> {
  ...
  void initState() {
    ...
    _model.autrePosteTextController ??= TextEditingController();
    _model.autrePosteFocusNode ??= FocusNode();
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Rentrer ici le mail du staff afin de vérifier si un compte existe déjà pour cette adresse mail :',
                          style:
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  onChanged: (_) => EasyDebounce.debounce(
                                    ...
                                    () async {
                                      _model.verifMailUserCreateStaff =
                        ...
                        if (_model.mailUserTextController.text != null &&
                          ...
                          Align(
                            ...
                            child: FlutterFlowDropDown<String>(
                              controller:
                                  _model.selectTypeStaffValueController ??=
                                      FormFieldController<String>(
                                _model.selectTypeStaffValue ??=
                                    _model.stockagePosteAutre,
                              ),
                              options: ['Coach', 'Prepa', 'Analyste', 'Autre'],
                              onChanged: (val) => safeSetState(
                                  () => _model.selectTypeStaffValue = val),
                              ...
                              hintText: 'Sélectionner le poste',
                              icon: Icon(
                        ...
                        if (_model.selectTypeStaffValue == 'Autre')
                          Row(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              Expanded(
                                child: Container(
                                  width: 200.0,
                                  child: TextFormField(
                                    controller: _model.autrePosteTextController,
                                    focusNode: _model.autrePosteFocusNode,
                                    autofocus: false,
                                    enabled: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          'Rentrer le poste que vous voulez ajouter ici',
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            font: GoogleFonts.inter(
                                    ...
                                    enableInteractiveSelection: true,
                                    validator: _model
                                        .autrePosteTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  _model.stockagePosteAutre =
                                      _model.autrePosteTextController.text;
                                },
                              ),
                            ],
                          ),
