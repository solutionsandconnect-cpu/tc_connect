...
class NavBarWebWidget extends StatefulWidget {
  const NavBarWebWidget({super.key});
...
class _NavBarWebWidgetState extends State<NavBarWebWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.comptageNbNotifStock = await queryNotificationsRecordCount(
      ...
      _model.nbNotifStock = _model.comptageNbNotifStock;
      _model.updatePage(() {});
    });
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          FFAppState().PageActuelle = 'Accueil';
                          FFAppState().update(() {});
                        },
                        child: AnimatedContainer(
                          ...
                          height: 44.0,
                          decoration: BoxDecoration(
                            color: FFAppState().PageActuelle == 'Accueil'
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed(PlanningWidget.routeName);

                          FFAppState().PageActuelle = 'Planning';
                          FFAppState().update(() {});
                        },
                        child: AnimatedContainer(
                          duration: Duration(milliseconds: 200),
                          ...
                          height: 44.0,
                          decoration: BoxDecoration(
                            color: FFAppState().PageActuelle == 'Planning'
                                ? FlutterFlowTheme.of(context).primary
                                : FlutterFlowTheme.of(context)
                                    .primaryBackground,
                            borderRadius: BorderRadius.circular(12.0),
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          FFAppState().PageActuelle = 'Notifications';
                          FFAppState().update(() {});
                        },
                        child: AnimatedContainer(
                          duration: Duration(milliseconds: 200),
                          ...
                          height: 44.0,
                          decoration: BoxDecoration(
                            color: FFAppState().PageActuelle == 'Notifications'
                                ? FlutterFlowTheme.of(context).primary
                                : FlutterFlowTheme.of(context)
                                    .primaryBackground,
                            borderRadius: BorderRadius.circular(12.0),
                    ...
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          FFAppState().PageActuelle = 'Profil';
                          FFAppState().update(() {});
                        },
                        child: AnimatedContainer(
                          duration: Duration(milliseconds: 200),
                          ...
                          height: 44.0,
                          decoration: BoxDecoration(
                            color: FFAppState().PageActuelle == 'Profil'
                                ? FlutterFlowTheme.of(context).primary
                                : FlutterFlowTheme.of(context)
                                    .primaryBackground,
                            borderRadius: BorderRadius.circular(12.0),
