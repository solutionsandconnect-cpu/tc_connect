...
import 'pop_up_notification_model.dart';
export 'pop_up_notification_model.dart';

class PopUpNotificationWidget extends StatefulWidget {
  const PopUpNotificationWidget({super.key});
...
class _PopUpNotificationWidgetState extends State<PopUpNotificationWidget> {
  late PopUpNotificationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PopUpNotificationModel());
