...
export default function ContenuSeancePage({ params }: { params: Promise<{ sessionId: string }> }) {
  ...
  return (
    <div className="space-y-5 pb-10">
      {/* Header : titre sur sa ligne, actions sur une ligne dédiée (évite le chevauchement sur mobile) */}
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button onClick={handleSave} disabled={saving}
            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white text-sm font-semibold px-4 py-2 rounded-xl transition shrink-0 ml-auto">
