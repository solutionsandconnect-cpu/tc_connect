...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: `Politique de confidentialité — ${nomApp}` }
}
    ...
    <div className="min-h-screen bg-white">
      <div className="w-full px-6 md:px-10 lg:px-16 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
          {brand === 'enezo' ? <EnezoPrivacyBody nomApp={nomApp} /> : <CoachingPrivacyBody nomApp={nomApp} />}
        </div>
      </div>
    </div>
  )
...
function CoachingPrivacyBody({ nomApp }: { nomApp: string }) {
  return (
    <>
      <section>
        <h2 className="text-xl font-semibold text-gray-900 mb-3">1. Présentation</h2>
        <p>
          {nomApp} (ci-après « l'Application ») est une application de gestion destinée aux coachs sportifs
...
function EnezoPrivacyBody({ nomApp }: { nomApp: string }) {
  return (
    <>
      <section>
        <h2 className="text-xl font-semibold text-gray-900 mb-3">1. Présentation</h2>
        <p>
          {nomApp} (ci-après « l'Application ») est l'espace client d'<strong>Enezo</strong>, studio de
          développement d'applications sur mesure édité par Teddy BLOUET (entrepreneur individuel).
          L'Application permet le suivi des projets et prestations, la consultation des devis, contrats,
          factures et documents, la communication avec Enezo, ainsi que l'accès à des applications proposées
          par abonnement. La présente politique explique comment nous collectons, utilisons, conservons et
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-2 mt-2">
          ...
          <li><strong>Données de contact</strong> : adresse e-mail, numéro de téléphone</li>
          <li><strong>Données de compte</strong> : identifiant unique, rôle dans l'application</li>
          <li><strong>Données de projet et de prestation</strong> : devis, contrats, documents, suivi de projet, échanges</li>
          <li><strong>Données de facturation</strong> : abonnements, historique des paiements</li>
          <li><strong>Données liées aux applications de la boutique</strong> : données que vous saisissez dans les applications auxquelles vous êtes abonné(e). Certaines de ces applications peuvent traiter des <strong>données personnelles sensibles</strong> (données relatives à la santé ou à un enfant, par exemple) — collectées uniquement avec votre consentement explicite et utilisées à la seule fin de fournir la fonctionnalité de l'application concernée</li>
          <li><strong>Données techniques</strong> : identifiant de l'appareil, logs de connexion</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-2 mt-2">
          <li>Gestion de votre compte et authentification</li>
          <li>Suivi des projets et prestations de développement</li>
          <li>Gestion des devis, contrats, factures et documents</li>
          <li>Fourniture des applications proposées par abonnement (boutique)</li>
          <li>Communication entre vous et Enezo</li>
          <li>Amélioration de l'application</li>
        </ul>
      </section>
      ...
      <section>
        <h2 className="text-xl font-semibold text-gray-900 mb-3">5. Base légale du traitement</h2>
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Exécution d'un contrat</strong> : données nécessaires à la prestation et au suivi des projets</li>
          <li><strong>Consentement explicite</strong> : données personnelles sensibles éventuellement traitées via les applications de la boutique (article 9 RGPD)</li>
          <li><strong>Intérêt légitime</strong> : amélioration du service, sécurité</li>
          <li><strong>Obligation légale</strong> : conservation des données de facturation</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li><strong>Données de compte</strong> : pendant la durée de la relation commerciale + 3 ans après la dernière connexion</li>
          <li><strong>Données de facturation</strong> : 10 ans (obligation légale)</li>
          <li><strong>Données de projet et de prestation</strong> : durée de la relation contractuelle, puis archivage conformément aux obligations légales ou suppression sur demande</li>
          <li><strong>Données des applications de la boutique</strong> : durée d'utilisation de l'application concernée, puis suppression sur demande</li>
          <li><strong>Logs techniques</strong> : 12 mois</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>Vos données sont accessibles :</p>
        <ul className="list-disc pl-6 space-y-2 mt-2">
          <li>Votre interlocuteur Enezo (accès à votre profil, à vos projets et à vos prestations)</li>
          <li><strong>Google Firebase</strong> (infrastructure cloud — hébergement, authentification, base de données) — serveurs susceptibles d'être localisés hors UE, encadrés par les clauses contractuelles types de la Commission européenne</li>
        </ul>
        <p className="mt-2">Nous ne vendons, ne louons ni ne partageons vos données avec des tiers à des fins commerciales.</p>
      </section>
...
/* Sections communes (droits, sécurité, mineurs, modifications, contact) — identiques aux deux marques. */
function PrivacyCommonTail() {
  return (
    <>
      <section>
